...
### 2. 実行ファイルの入手
GitHubの [Releases](https://github.com/AaA-11-1011/CULC_GDP/releases) から最新の `culc_gdp_vX.X.X_win.zip` をダウンロードし、解凍します。(Windows11なら右クリ->すべて展開)
